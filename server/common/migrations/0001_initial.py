    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legibility', models.CharField(choices=[('L', 'Legible'), ('I', 'Illegible')], max_length=1, null=True)),
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='text_instances', to='common.CocoTextImage')),
                ('parent_instance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child_instances', to='common.CocoTextInstance')),
            ],
            options={
                'abstract': False,
            },
